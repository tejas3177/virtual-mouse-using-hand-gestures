...
class Controller:
    ...
    def changesystembrightness(self):
        ...
        # Assuming brightness_list contains only one value, extract it
        currentBrightnessLv = brightness_list[0] / 100.0

        brightnessChange = Controller.pinchlv * 0.02
        newBrightnessLv = currentBrightnessLv + brightnessChange
    ...
    def scrollHorizontal(self,):
        ...
        # Adjust the scrolling distance based on Controller.pinchlv
        scroll_distance = 120 if Controller.pinchlv > 0.0 else -120
